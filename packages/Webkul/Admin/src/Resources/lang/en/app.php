...
return [
    ...
    'common' => [
        'no-result-found' => 'Мы не смогли ничего найти.',
        'country' => 'Страна',
        'state' => 'Регион',
        'true' => 'True',
        'false' => 'False'
    ...
    'layouts' => [
        ...
        'attribute-families' => 'Семейство аттрибутов',
        'customers' => 'Клиенты',
        'groups' => 'Группы',
        'reviews' => 'Отзывы',
        ...
        'inventory-sources' => 'Складской учет',
        'channels' => 'Каналы',
        'users' => 'Пользователи',
        'roles' => 'Роли',
        'sliders' => 'Слайдеры',
    ...
    'acl' => [
        ...
        'categories' => 'Категории',
        'attributes' => 'Аттрибуты',
        'attribute-families' => 'Группы аттрибутов',
        'customers' => 'Клиенты',
        'groups'=> 'Группы',
        'reviews' => 'Отзывы',
        'newsletter-subscriptions' => 'Подписки рассылок',
        'configure' => 'Конфигурация',
        'settings' => 'Настройки',
        'locales' => 'Локализации',
        'currencies' => 'Валюты',
        ...
        'delete' => 'Удалить',
        'promotions' => 'Реклама',
        'cart-rules' => 'Настройки корзины',
        'catalog-rules' => 'Настройки каталога',
    ],
    ...
    'dashboard' => [
        ...
        'decreased' => ':progress%',
        'sales' => 'Продажи',
        'top-performing-categories' => 'Топовые категории',
        'product-count' => ':count Products',
        'top-selling-products' => 'Топовые товары',
    ...
    'datagrid' => [
        'mass-ops' => [
            'method-error'=> 'Ошибка! Неправильный метод. Пожалуйста, проверьте настройки групповых изменений',
